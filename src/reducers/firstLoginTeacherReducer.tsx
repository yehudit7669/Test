...
const initialState: State = {
    ...
    // Temporary data - This data will be attained from API call
    subjectsInterestChipDetails:[
      {id:'1',label:'Arts',selected:false},{id:'2',label:'Biology',selected:false}, 
      {id:'3',label:'History',selected:false}, {id:'4',label:'Maths',selected:false}, 
      {id:'5',label:'English',selected:false}, {id:'6',label:'History',selected:false}
    ],
    // Temporary data - This data will be attained from API call
    ...
    wizerInterestsChipDetails:[
      ...
      {id:'3',label:'Easy way to differentiate assignments',selected:false}, 
      {id:'4',label:'Create fun worksheets for my students',selected:false}, 
    ...
    // Temporary data - This data will be attained from API call
    schoolDetails:[
      {id:'1',schoolName:'School 1',schoolAddress:"5656 S 129th E Ave, Tulsa, OK 74134, United States",totalNoOfTeachers:'10',selected:false},
      {id:'2',schoolName:'School 2',schoolAddress:"5656 S 129th E Ave, Tulsa, OK 74134, United States",totalNoOfTeachers:'4',selected:false},
      {id:'3',schoolName:'School 3',schoolAddress:"5656 S 129th E Ave, Tulsa, OK 74134, United States",totalNoOfTeachers:'6',selected:false},
      {id:'4',schoolName:'School 4',schoolAddress:"5656 S 129th E Ave, Tulsa, OK 74134, United States",totalNoOfTeachers:'9',selected:false},
      {id:'5',schoolName:'School 5',schoolAddress:"5656 S 129th E Ave, Tulsa, OK 74134, United States",totalNoOfTeachers:'9',selected:false},
    ]
    // Temporary data - This data will be attained from API call
};
...
const firstLoginTeacher = produce((draft: State, action: any) => {
  ...
  switch (action.type) {
    case Actions.SET_FIRST_LOGIN_TEACHER_DETAILS: 
      draft.firstLoginTeacherDetails = { ...draft.firstLoginTeacherDetails,...payload };
      break;
    ...
    case Actions.FIRST_LOGIN_TEACHER_UPDATE_SUBJECTS_INTEREST_CHIP_DETAILS:
      draft.subjectsInterestChipDetails = [...payload.multipleSelectableChipsArr]
      break;
