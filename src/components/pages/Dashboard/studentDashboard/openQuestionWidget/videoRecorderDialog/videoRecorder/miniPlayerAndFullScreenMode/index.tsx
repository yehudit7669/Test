import { FullScreenCloseIcon, FullScreenOpenIcon, MiniPlayerIcon } from "../../../../../../../../assets/svgs/svg-components";
...
export default function RenderMiniPlayerAndFullScreenMode(){
    ...
    const {isMiniPlayerMode, setIsMiniPlayerMode, liveVideoFeed, setIsFullScreenMode} = useVideoRecorderContext()
    /* Context dependencies */
